...
:::tip[Next: Lesson 1]
Ready to build real engineering parts? Start with [Lesson 1: Parametric Hardware Library from Engineering Standards](./parametric-hardware-library-engineering-standards), where you will generate 50+ ISO-standard fasteners from code.
:::
