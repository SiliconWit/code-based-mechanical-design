...
3. **Install the OCP CAD Viewer extension in VS Code**:
   Open VS Code, go to Extensions (Ctrl+Shift+X), search for "OCP CAD Viewer," and install it. This gives you a live 3D viewport that updates as you run cells.
...
4. **Start Jupyter and verify the installation**:
   ...
   show(box)
   ```
   If you see a 10 mm cube in the OCP CAD Viewer panel, your setup is working.
