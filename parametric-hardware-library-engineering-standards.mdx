...
2. **Install CadQuery and Jupyter**:
   ```bash
...
3. **Verify the installation**:
   ...
   print("CadQuery is working! Exported test_box.step and test_box.stl")
   ```
   Open the exported `.step` file in FreeCAD or any CAD viewer to confirm the geometry looks correct.
</Steps>
...
4. **Verify the installation**:
   ...
   print("CadQuery is working! Exported test_box.step and test_box.stl")
   ```
   Open the exported `.step` file in FreeCAD or any CAD viewer to confirm the geometry.
</Steps>
